...
func getRegions() []Region {
	...
	return []Region{forwell, inn, blacksmithRegion}
}
...
func getRooms() []Room {
	var blacksmith = Room{
		UID:    "_:blacksmith",
		Type:   "Room",
		Region: Region{UID: "_:region_blacksmith"},
		Slug:   "blacksmith",
		Name:   "Blacksmith",
	...
	var mainStreet = Room{
		UID:    "_:mainStreet",
		Type:   "Room",
		Region: Region{UID: "_:region_forwell"},
		...
		Exits: []Exit{
			...
			Exit{
				Dest:      []Room{Room{UID: "_:blacksmith"}},
				Direction: "SOUTH",
				Portal:    "OPEN",
				Type:      "Exit",
			},
	...
	var northRoom = Room{
		UID:    "_:northRoom",
		Type:   "Room",
		Region: Region{UID: "_:region_inn"},
	...
	var commonRoom = Room{
		...
		Exits: []Exit{
			Exit{
				Dest:      []Room{Room{UID: "_:northRoom"}},
				Direction: "NORTH",
				Portal:    "OPEN",
				Type:      "Exit",
			},
	...
	return []Room{blacksmith, mainStreet, northRoom, commonRoom}
}
