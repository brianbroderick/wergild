...
func (ls *LetStatement) TokenLiteral() string { return ls.Token.Lit }
...
func (rs *ReturnStatement) TokenLiteral() string { return rs.Token.Lit }
...
func (fl *FunctionLiteral) TokenLiteral() string { return fl.Token.Lit }
